...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (b, a) {
            ...
            for (var b = [].concat(b), a, d = [], h = 0; h < b.length; h++)if (a = b[h])/@import|[{}]/.test(a) ? d.push("<style>" + a + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + a + '">');
            return d.join("")
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
            ...
            isEmptyInlineRemoveable: function () {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++)if (e)for (var j = 0; j < e.length; j++)b.push([a, c[i], e[j]].join("-")); else b.push([a, c[i]].join("-"));
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_COMMENT)l = l.getPrevious(); else {
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    /[^\s\ufeff]/.test(j) && (l = null);
                                    r = /[\s\ufeff]$/.test(j)
                                } else if ((l.$.offsetWidth > 0 || b && l.is("br")) && !l.data("cke-bookmark"))if (i && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                    j = l.getText();
                                    if (/[^\s\ufeff]/.test(j))l = null; else for (var g = l.$.getElementsByTagName("*"), n = 0, E; E = g[n++];)if (!CKEDITOR.dtd.$removeEmpty[E.nodeName.toLowerCase()]) {
                                        l = null;
                                        break
                                    }
                                    l && (r = !!j.length)
            ...
            var h = {}, g = function (b) {
                a.call(this, b, function (a) {
                    ...
                    for (n in a) {
                        ...
                        if (!e[n]) {
                            if (q.icons)for (var u = q.icons.split(","), f = u.length; f--;)CKEDITOR.skin.addIcon(u[f], q.path + "icons/" + (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") + u[f] + ".png");
                            e[n] = 1
                        }
                        if (s) {
                            s.split && (s = s.split(","));
    ...
    (function () {
        ...
        a.prototype = {add: function (a, c, d) {
            ...
            for (var e = [this.findIndex(c), 0], g = 0, n = a.length; g < n; g++)e.push({value: a[g], priority: c, options: d});
    ...
    (function () {
        ...
        var y = /(?:&nbsp;|\xa0)$/, m = "{cke_protected}", k = CKEDITOR.dtd, l = ["caption", "colgroup", "col", "thead", "tfoot",
            "tbody"], t = CKEDITOR.tools.extend({}, k.$blockLimit, k.$block), x = {elements: {input: n, textarea: n}}, r = {attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""]
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, e, b;
            for (b in CKEDITOR.dtd.$editable)for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, h = c.count(); d < h; d++) {
                a = c.getItem(d);
                if (a.getAttribute("contenteditable") == "true") {
                    e = {element: a, config: {}};
            ...
            return function (h, j, o) {
                ...
                if (!x.checkReadOnly()) {
                    ...
                    if (w = o) {
                        ...
                        if (/^\s+|\s+$/.test(o) && "span"in CKEDITOR.dtd[D])var u = '<span data-cke-marker="1">&nbsp;</span>', o = u + o + u;
            ...
            if (b.collapsed) {
                ...
                for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(o)) {
                        ...
                        if (p && i && CKEDITOR.dtd.$block[s])for (var t = n, x = c(t), z = void 0, A = x.length, I = 0, t = A && new CKEDITOR.dom.range(t.getDocument()); I < A; ++I) {
                        ...
                        if (x)if ((x = n.getParent()) && ((x.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(x))) {
                            ...
                            if (s == CKEDITOR.NODE_TEXT || p || s == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                for (var s = n, W; (j = !s.getNext(E)) && (W = s.getParent(), k[W.getName()]) && (W.getPosition(m) | Q) == Q && (!g.childRule || g.childRule(W));)s = W;
                                q.setEndAfter(s)
                            }
        ...
        CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {labeledElement: function (b, a, d, e) {
            if (!(4 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, {role: "presentation"}, function () {
                    ...
                    "horizontal" !=
                        a.labelLayout ? f.push('<label class="cke_dialog_ui_labeled_label' + d + '" ', ' id="' + c.labelId + '"', c.inputId ? ' for="' + c.inputId + '"' : "", (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">", a.label, "</label>", '<div class="cke_dialog_ui_labeled_content"', a.controlStyle ? ' style="' + a.controlStyle + '"' : "", ' role="radiogroup" aria-labelledby="' + c.labelId + '">', e.call(this, b, a), "</div>") : (d = {type: "hbox", widths: a.widths, padding: 0, children: [
